...
lies between O(1) and O(logn) inclusive.
In-place algorithm is an algorithm that does need a
...
/*
ANS.3
In-place techniques have lesser space complexity but are difficult to implement whereas out-place techniques are easy to implement but 
